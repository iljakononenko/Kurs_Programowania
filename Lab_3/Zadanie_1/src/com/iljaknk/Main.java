            ...
            for (int i = 0; i < rodzaje_podanych_figur.length(); i++)
            {
                ...
                switch (litera)
                {
                    ...
                    case 'o':
                    {
                        ...
                        {
                            figury.add(new One_parametr_figure(Figura.one_parametr_figures.OKRAG, promien));
                        }
                    ...
                    case 'c':
                    {
                        ...
                        else
                        {
                            try
                            {
                                figury.add(Figura.decide_czworokat(boki, kat));
                            }
                    ...
                    case 'p':
                    {
                        ...
                        {
                            figury.add(new One_parametr_figure(Figura.one_parametr_figures.PIECIOKAT, bok));
                        }
                        break;
                    }
                    ...
                    case 's':
                    {
                        ...
                        {
                            figury.add(new One_parametr_figure(Figura.one_parametr_figures.SZESCIOKAT, bok));
                        }
                        break;
                    }
